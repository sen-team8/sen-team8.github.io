...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginActions = __webpack_require__(185);

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	var initialLoginState = {
	  STATUS: _loginActions.LOGGED_OUT,
	  ID: null,
	  PASS: null
	};

	var getId = function getId(state) {
	  return state.todos.reduce(function (maxId, todoItem) {
	...
	function todo() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? todoState : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {

	    case _todoActions.CREATE_TODO:
	    ...
	    case _todoActions.COMPLETE_TODO:
	      return _extends({}, state, {
	        todos: state.todos.map(function (todoItem) {
	          return todoItem.ID === action.ID ? _extends({}, todoItem, { completed: !todoItem.completed }) : todoItem;
	        })
	      });
	    ...
	    case _todoActions.EDIT_TODO:
	      return _extends({}, state, {
	        todos: state.todos.map(function (todoItem) {
	          return todoItem.ID === action.TODO.ID ? _extends({}, todoItem, { TEXT: action.TODO.TEXT }) : todoItem;
	        })
	      });
	...
	function login() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initialLoginState : arguments[0];
	  var action = arguments[1];
	  ...
	  switch (action.type) {
	    ...
	    case _loginActions.LOGGED_OUT:
	      return _extends({}, state, {
	        STATUS: action.type
	      });
	    case _loginActions.LOGGING:
	      return _extends({}, state, {
	        STATUS: action.type,
	        ID: action.id,
	        PASS: action.pass
	      });
	    case _loginActions.LOGIN_ERROR:
	      return _extends({}, state, {
	        STATUS: action.type
	      });
	    default:
	...
	exports.default = (0, _redux.combineReducers)({ todo: todo, login: login });
...
/***/ function(module, exports) {
	...
	var LOGGING = exports.LOGGING = 'LOGGING';
	var LOGGED_OUT = exports.LOGGED_OUT = 'LOGGED_OUT';
	var LOGIN_ERROR = exports.LOGIN_ERROR = 'LOGIN_ERROR';

	function setLogging(user) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CreateTodo = __webpack_require__(188);
	...
	var Todo = function (_Component) {
	  ...
	  function Todo(props) {
	    ...
	    _this.state = { show: 'All' };
	    _this.handleStateChange = _this.handleStateChange.bind(_this);
	    _this.actionHandler = _this.actionHandler.bind(_this);
	    return _this;
	  }

	  _createClass(Todo, [{
	    key: 'showCreateTodo',
	    value: function showCreateTodo() {
	      if (this.state.show === 'All') {
	        return _react2.default.createElement(_CreateTodo2.default, { actions: this.actionHandler });
	      }
	      return _react2.default.createElement('div', null);
	    }
	  }, {
	    key: 'handleStateChange',
	    value: function handleStateChange(text) {
	      this.setState({ show: text });
	    }
	  }, {
	    key: 'actionHandler',
	    value: function actionHandler(action, id, text) {
	      switch (action) {
	        case 'complete':
	        ...
	        case 'delete':
	          ...
	          break;
	        case 'edit':
	          var x = this.props.todos.filter(function (todoItem) {
	          ...
	          break;
	        case 'Create':
	          var y = this.props.todos.filter(function (todoItem) {
	            return todoItem.TEXT === text;
	          });
	          if (y.length === 0) {
	            if (text) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.showCreateTodo(),
	        _react2.default.createElement(_TodoList2.default, { actions: this.actionHandler, todos: this.props.todos,
	...
	function mapStateToProps(state) {
	  return _extends({}, state.reducer.todo);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _textField = __webpack_require__(189);

	var _textField2 = _interopRequireDefault(_textField);

	var _raisedButton = __webpack_require__(252);
	...
	var CreateTodo = function (_React$Component) {
	  ...
	  function CreateTodo() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(CreateTodo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      text: ''
	      ...
	      e.preventDefault();
	      _this.props.actions('Create', 1, _this.state.text);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'Add', style: style })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(275);
	...
	var TodoList = function (_React$Component) {
	  ...
	  function TodoList() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TodoList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      ...
	      _this.props.handleStateChange('All');
	      _this.setState({
	        showAll: true,
	        showCompleted: false
	      });
	    }, _this.handleShowCompleted = function () {
	      _this.props.handleStateChange('Completed');
	      _this.setState({
	        showAll: false,
	        showCompleted: true
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.todos.map(function (todo) {
	          return _react2.default.createElement(_TodoItem2.default, {
	            ...
	            verifyTodo: _this2.verifyTodo
	          });
	        }),
	        _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'All', style: styleB, onClick: this.handleShowAll }),
	        _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'Completed', style: styleB, onClick: this.handleShowCompleted })
	      );
	    }
	  }]);
	...
	TodoList.propTypes = {
	  handleStateChange: _react.PropTypes.func.isRequired,
	  todos: _react.PropTypes.array.isRequired,
	  actions: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = function (_React$Component) {
	  ...
	  function TodoItem() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TodoItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      isEditing: false,
	      text: _this.props.todo.TEXT
	    }, _this.handleDeleteTodo = function () {
	      _this.props.actions('delete', _this.props.todo.ID);
	    }, _this.handleDoubleClick = function () {
	      _this.setState({
	        isEditing: true,
	        text: _this.props.todo.TEXT
	      });
	    }, _this.handleCompleteTodo = function () {
	      _this.props.actions('complete', _this.props.todo.ID);
	    }, _this.handleSave = function () {
	      _this.props.actions('edit', _this.props.todo.ID, _this.state.text);
	    }, _this.handleTextChange = function (e) {
	      _this.setState({
	        text: e.target.value
	      });
	    }, _this.textArea = function () {
	      if (_this.state.isEditing === false) {
	        if (_this.props.showCompleted === true && _this.props.todo.completed === false) {
	          return _react2.default.createElement('div', null);
	        }
	        return _react2.default.createElement(
	          'div',
	          { style: styleD, onDoubleClick: _this.handleDoubleClick },
	          _react2.default.createElement(
	            'div',
	            { style: styleP },
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'Del', style: styleB, onClick: _this.handleDeleteTodo }),
	          _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'Done', style: styleB, onClick: _this.handleCompleteTodo })
	        );
	      } else {
	        return _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'div',
	            { style: styleP },
	            _react2.default.createElement(_textField2.default, { value: _this.state.text, onChange: _this.handleTextChange })
	          ),
	          _react2.default.createElement(_raisedButton2.default, { type: 'submit', label: 'Save', style: styleB, onClick: _this.handleSave })
	        );
	      }
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	...
	TodoItem.propTypes = {
	  ...
	  actions: _react.PropTypes.func.isRequired,
	  showCompleted: _react.PropTypes.bool.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = exports.actions = {
	  createTodo: _todoActions.createTodo,
	  deleteTodo: _todoActions.deleteTodo,
	  completeTodo: _todoActions.completeTodo,
	  editTodo: _todoActions.editTodo,
	  setLogging: _loginActions.setLogging,
	  setLogout: _loginActions.setLogout,
	  setLoggedIn: _loginActions.setLoggedIn,
	  setLoginError: _loginActions.setLoginError
	};
